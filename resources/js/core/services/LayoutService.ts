...
class LayoutService {
    ...
    public static initDefaultLayout(): void {
        ...
        if (objectPath.get(config.value, "wrapper.container") === "fixed") {
            ...
            objectPath.get(config.value, "wrapper.container") === "fluid"
        ) {
            this.bodyStore.addClassname({
                position: "wrapper-container",
                className: "container-fluid",
    ...
    public static initToolbar(): void {
        ...
        if (objectPath.get(config.value, "toolbar.container") === "fixed") {
            ...
            objectPath.get(config.value, "toolbar.container") === "fluid"
        ) {
            this.bodyStore.addClassname({
                position: "toolbar-container",
                className: "container-fluid",
    ...
    public static initSidebar(): void {
        ...
        if (
            objectPath.get(
                config.value,
                "sidebar.default.minimize.desktop.default"
            )
        ) {
            this.bodyStore.addBodyAttribute({
        ...
        if (
            objectPath.get(
                config.value,
                "sidebar.default.minimize.desktop.hoverable"
            )
        ) {
            this.bodyStore.addBodyAttribute({
        ...
        if (
            objectPath.get(
                config.value,
                "sidebar.primary.minimize.desktop.enabled"
            )
        ) {
            if (
                objectPath.get(
            ...
            if (
                objectPath.get(
                    config.value,
                    "sidebar.primary.minimize.mobile.enabled"
                )
            ) {
                if (
                    objectPath.get(
            ...
            if (
                objectPath.get(
                    config.value,
                    "sidebar.primary.collapse.desktop.enabled"
                )
            ) {
                if (
                    objectPath.get(
            ...
            if (
                objectPath.get(
                    config.value,
                    "sidebar.primary.collapse.mobile.enabled"
                )
            ) {
                if (
                    objectPath.get(
    ...
    public static initSidebarPanel(): void {
        ...
        if (
            objectPath.get(
                config.value,
                "sidebarPanel.minimize.desktop.enabled"
            )
        ) {
            if (
                objectPath.get(
                    config.value,
                    "sidebarPanel.minimize.desktop.default"
                )
            ) {
                this.bodyStore.addBodyAttribute({
            ...
            if (
                objectPath.get(
                    config.value,
                    "sidebarPanel.minimize.mobile.enabled"
                )
            ) {
                if (
                    objectPath.get(
    ...
    public static initHeader(): void {
        ...
        if (objectPath.get(config.value, "header.default.fixed.desktop")) {
            ...
            this.bodyStore.addBodyAttribute({
                qualifiedName: "data-kt-app-header-minimize",
                value: "on",
            });
        }
