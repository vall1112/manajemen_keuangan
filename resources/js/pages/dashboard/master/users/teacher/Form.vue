...
const formSchema = Yup.object().shape({
    ...
    passwordConfirmation: Yup.string()
        ...
        .nullable(),
    teacher_id: Yup.string().required("Pilih guru"),
...
function submit() {
    ...
    formData.append("role_id", TEACHER_ROLE_ID.toString());
...
<template>
    <VForm class="form card mb-10" @submit="submit" :validation-schema="formSchema" id="form-user" ref="formRef">
        <div class="card-header align-items-center">
            <h2 class="mb-0">{{ selected ? "Edit" : "Tambah" }} Pengguna Guru</h2>
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <Field name="teacher_id" type="hidden" v-model="user.teacher_id">
                            <select2 placeholder="Pilih guru" class="form-select-solid" :options="teachers"
                                name="teacher_id" v-model="user.teacher_id" required />
                        </Field>
