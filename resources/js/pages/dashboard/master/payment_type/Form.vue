...
function submit() {
    ...
    formData.append("kode", paymentType.value.kode);
...
<template>
    <VForm class="form card mb-10" @submit="submit" :validation-schema="formSchema" id="form-payment-type"
        ref="formRef">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <Field class="form-control form-control-lg form-control-solid" type="text" name="kode"
                            autocomplete="off" v-model="paymentType.kode"
                            placeholder="Masukkan kode jenis pembayaran" />
                ...
                <div class="col-md-6">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <Field class="form-control form-control-lg form-control-solid" type="text" name="nama_jenis"
                            autocomplete="off" v-model="paymentType.nama_jenis"
                ...
                <div class="col-md-6">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <Field as="textarea" class="form-control form-control-lg form-control-solid" name="keterangan"
                            v-model="paymentType.keterangan" placeholder="Masukkan keterangan (opsional)" />
                        <div class="fv-plugins-message-container">
                            <div class="fv-help-block">
