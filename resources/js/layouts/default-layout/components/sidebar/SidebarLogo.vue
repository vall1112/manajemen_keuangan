    ...
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
        ...
        <router-link to="/">
            <img v-if="layout === 'dark-sidebar' ||
                ...
                " alt="Logo" :src="setting?.logo_sekolah" class="h-50px app-sidebar-logo-default" />
            <img v-if="themeMode === 'light' && layout === 'light-sidebar'" alt="Logo" :src="setting?.logo_sekolah"
                class="h-50px app-sidebar-logo-default" />
            <img alt="Logo" :src="setting?.logo_sekolah" class="h-50px app-sidebar-logo-minimize" />
        </router-link>
        <!--end::Logo image-->
